...
public class Dairy {
    ...
    public Dairy(){
        JFrame frame = new JFrame("Dairy");
        frame.setBounds(0, 0, 630, 1000);
        ...
        // 배열 설정 부분
        String menu[] = { "Eggs", "Plain Yogurt", "Blueberry Yogurt", "Nonfat Milk", "2% Milk", "Whole Milk", "Butter", "Organic Eggs" };
        double price[] = { 3.25, 5.5, 6, 2.2, 1.85, 1.9,2.75, 2.66 };
        ...
        ta.setText("     Product\t      Price\t      Quantity\t      Total\n\n");
        ...
        Button bt2 = new Button("Initialize");
